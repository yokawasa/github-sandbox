...
vi test.md
# マニュアルで修復以外に、--ours / --their でどの変更を取り込むかを選択することも可能
# --ours = 今の状態を残す
# --theirs = あとから乗せようとしている変更を使う
git checkout --ours test.md    # 今の状態を使う（残す）
git checkout --their test.md   # これから上書きしようとしている変更を使う
